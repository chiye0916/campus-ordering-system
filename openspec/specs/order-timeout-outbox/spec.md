...
Order timeout outbox persists timeout-message send intent in MySQL so order creation and asynchronous RabbitMQ publishing remain reliable across request, broker, and publisher failures.
