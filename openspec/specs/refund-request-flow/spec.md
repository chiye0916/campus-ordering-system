...
Refund request flow defines the user-facing after-sales refund request lifecycle, administrator review actions, visibility rules, and legacy order-level refund fallback behavior.
