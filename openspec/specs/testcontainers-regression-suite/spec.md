# testcontainers-regression-suite Specification

## Purpose
Define the project's Docker-backed Testcontainers regression workflow, including the split between fast unit tests and explicit integration tests, container infrastructure, cleanup rules, helper scope, and the first three critical regression flows.
