...
Define the observability and reliability baseline for trace correlation, safe Actuator exposure, low-cardinality metrics, outbox visibility, and manual smoke/load checks.
